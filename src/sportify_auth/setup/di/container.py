...
from sportify_auth.application.protocols.repositories import (
	IOutboxRepository, ITransactionManager,
	IUserRepository
)
...
from sportify_auth.application.interactors.token import (
	...
	RefreshTokenInteractor, RevokeTokenInteractor,
)
...
dependency_container[UserActivateConfirmInteractor] = dependencies.new_user_activate_confirm_interactor

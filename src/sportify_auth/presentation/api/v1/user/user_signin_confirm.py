...
@signin_confirm_router.post("/signin_confirm", response_model=UserSignInConfirmResponseSchema)
async def signin_confirm(
	request_data: UserSignInConfirmRequestSchema,
	interactor: Annotated[UserSignInConfirmInteractor, Depends(Stub(UserSignInConfirmInteractor))],
):

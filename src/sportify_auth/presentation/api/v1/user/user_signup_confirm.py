...
@signup_confirm_router.post("/signup_confirm", response_model=UserSignUpConfirmResponseSchema)
async def signup_confirm(
	request_data: UserSignUpConfirmRequestSchema,
	interactor: Annotated[UserSignUpConfirmInteractor, Depends(Stub(UserSignUpConfirmInteractor))],
):

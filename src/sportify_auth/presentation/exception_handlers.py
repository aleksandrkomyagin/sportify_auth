...
from sportify_auth.application.common.exceptions.base import BaseDetailException, BaseAppException
from sportify_auth.infrastructure.common.exceptions.base import BaseInfraException, BaseServiceAuthException
